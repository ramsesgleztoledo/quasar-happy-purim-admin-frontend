<template>
  <div class="row q-mb-lg"><PaginationCustom /></div>
  ...
  <div class="q-mb-md">
    <div class="row">
      ...
      <div v-if="!isMobile" class="col-12 top-title-col">
        <p class="MemberPage-user-title">Blumenfeld George</p>
        <div class="separator-right q-mr-sm q-ml-sm"></div>
        <p class="MemberPage-login-code" @click="copyToClipboard('DCMJQ-KFMTB')">
          Login Code:
          <b> DCMJQ-KFMTB</b>
        </p>
        <div class="separator-right q-mr-sm q-ml-sm"></div>
        <p
          ...
          @click="
            copyToClipboard(
              'https://www.happypurim.com/sso.aspx?token=f80f5ba9-3dfd-4170-a1a2-7d0d90611dc3',
            )
          "
        >
          SignOn Link:
          <b> https://www.happypurim.com/sso.aspx?token=f80f5ba9-3dfd-4170-a1a2-7d0d90611dc3</b>
        </p>
      </div>
      <!--=========================== END OF SECTION ===========================-->
      <!--=============================== if mobile =============================-->
